...
First public Windows-port preview.

### Added

- Avalonia/.NET 10 Windows desktop application
...
- SVG and CSV export
- Self-contained x64/ARM64 release automation and optional x64 installer
...
- Code signing, PNG/PDF export, freehand tools, and full accessibility testing
